            ...
            <form class="monitoring-filter" method="GET" action="{{ route('potentials.kompetisi') }}">
                <div class="row g-3 align-items-end">
                    <div class="col-12 col-md-3">
                        ...
                        <input type="month" name="periode" value="{{ request('periode', now('Asia/Jakarta')->format('Y-m')) }}" class="form-control">
                    </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editModalLabel{{ $item->id }}">Edit Kompetisi - {{ $item->nama_dealer }}</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <form action="{{ route('potentials.update-kompetisi', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label class="form-label">Kompetitor</label>
                                                                <select name="kompetitor" class="form-select kompetitor-select" onchange="toggleKompetitor(this, {{ $item->id }})">
                                                                    <option value="">- Pilih -</option>
                                                                    <option value="Ada" @selected($item->kompetitor == 'Ada')>Ada</option>
                                                                    <option value="Tidak Ada" @selected($item->kompetitor == 'Tidak Ada')>Tidak Ada</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Insentif</label>
                                                                <select name="insentif" class="form-select dep-select-{{ $item->id }}" data-current="{{ $item->insentif }}">
                                                                    <option value="">- Pilih -</option>
                                                                    <option value="Sangat Unggul" class="opt-sangat-unggul" @selected($item->insentif == 'Sangat Unggul')>Sangat Unggul</option>
                                                                    <option value="Lebih Unggul" class="opt-lain" @selected($item->insentif == 'Lebih Unggul')>Lebih Unggul</option>
                                                                    <option value="Sama dengan Kompetitor" class="opt-lain" @selected($item->insentif == 'Sama dengan Kompetitor')>Sama dengan Kompetitor</option>
                                                                    <option value="Di bawah Kompetitor" class="opt-lain" @selected($item->insentif == 'Di bawah Kompetitor')>Di bawah Kompetitor</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Harga</label>
                                                                <select name="harga" class="form-select dep-select-{{ $item->id }}" data-current="{{ $item->harga }}">
                                                                    <option value="">- Pilih -</option>
                                                                    <option value="Sangat Unggul" class="opt-sangat-unggul" @selected($item->harga == 'Sangat Unggul')>Sangat Unggul</option>
                                                                    <option value="Lebih Unggul" class="opt-lain" @selected($item->harga == 'Lebih Unggul')>Lebih Unggul</option>
                                                                    <option value="Sama dengan Kompetitor" class="opt-lain" @selected($item->harga == 'Sama dengan Kompetitor')>Sama dengan Kompetitor</option>
                                                                    <option value="Di bawah Kompetitor" class="opt-lain" @selected($item->harga == 'Di bawah Kompetitor')>Di bawah Kompetitor</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Grooming</label>
                                                                <select name="grooming" class="form-select dep-select-{{ $item->id }}" data-current="{{ $item->grooming }}">
                                                                    <option value="">- Pilih -</option>
                                                                    <option value="Sangat Unggul" class="opt-sangat-unggul" @selected($item->grooming == 'Sangat Unggul')>Sangat Unggul</option>
                                                                    <option value="Lebih Unggul" class="opt-lain" @selected($item->grooming == 'Lebih Unggul')>Lebih Unggul</option>
                                                                    <option value="Sama dengan Kompetitor" class="opt-lain" @selected($item->grooming == 'Sama dengan Kompetitor')>Sama dengan Kompetitor</option>
                                                                    <option value="Di bawah Kompetitor" class="opt-lain" @selected($item->grooming == 'Di bawah Kompetitor')>Di bawah Kompetitor</option>
                                                                </select>
                                                            </div>
                                                        </div>
